 ...
 * @version v1.0
 * @create 2017-05-16 14:48
 **/
public class CloudStorageConfig implements Serializable {
    private static final long serialVersionUID = -8521431445007886618L;
     ...
     * 七牛域名
     */
    @NotBlank(message = "七牛绑定域名不能为空", groups = { QiniuGroup.class })
    @URL(message = "七牛绑定域名格式不正确", groups = { QiniuGroup.class })
     ...
     * 命名空间
     */
    @NotBlank(message = "七牛命名空间不能为空", groups = { QiniuGroup.class })
