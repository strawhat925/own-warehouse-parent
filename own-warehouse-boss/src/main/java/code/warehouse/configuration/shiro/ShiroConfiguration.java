...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        logger.debug("注入Shiro的Web过滤器-->shiroFilter", ShiroFilterFactoryBean.class);
        ...
        filterChainDefinitionMap.put("/sys/login", "anon");//anon 可以理解为不拦截
    ...
    public SecurityManager securityManager(UserRealm userRealm) {
        logger.debug("注入Shiro的Web过滤器-->securityManager", ShiroFilterFactoryBean.class);
     ...
     */
    @Bean
    //bean依赖，强制初始化lifecycleBeanPostProcessor bean
